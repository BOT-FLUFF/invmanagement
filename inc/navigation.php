	<!-- Navigation -->
  <nav class="m-0 navbar navbar-expand-lg navbar-dark fixed-top" style="background: 		#095d7e;">
      <div class="container">
        <a class="navbar-brand" href="<?php echo ROOT_URL; ?>">Medicine Inventory System</a>
